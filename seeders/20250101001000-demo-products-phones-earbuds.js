...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const phones = [
      ...
      // Ajoutez d'autres modèles de OnePlus depuis 2020 si nécessaire
    ];
    ...
    const earbuds = [
      // Apple AirPods Pro
      {
        ...
        date_release: '2019-10-30', // Bien que sortie avant 2020, conserver pour cohérence
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ...
    phones.forEach(phone => {
      ...
      if (product) {
        specifications.push({
          ...
          specification_value: phone.date_release.toISOString().split('T')[0],
          createdAt: new Date(),
          updatedAt: new Date(),
        });
      }
    ...
    earbuds.forEach(earbud => {
      ...
      if (product) {
        specifications.push({
          productId: product.id,
          specification_key: 'Date de sortie',
          specification_value: earbud.date_release.toISOString().split('T')[0],
          createdAt: new Date(),
          updatedAt: new Date(),
        });
      }
